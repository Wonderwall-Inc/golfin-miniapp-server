...
class UserModel(Base):
    ...
    wallet_address: Mapped[Optional[str]] = mapped_column(String(100), nullable=True) # REVIEW: allow mutliple?
    ...
    game_characters: Mapped[Set["GameCharacterModel"]] = relationship(back_populates="user")
